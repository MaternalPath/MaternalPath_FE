...
const FundWalletForm = ({
  ...
  const progressPercent = Math.round(
    (walletData.currentBalance / walletData.savingsGoal) * 100,
  );
  ...
  return (
    <section className="fund-wallet-card">
      <h2>Fund Emergency Wallet</h2>
      <p className="subtitle">
        Add money securely through KoraPay to continue building your delivery
        savings.
      </p>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="savings-progress-card">
          ...
          <div className="progress-amounts">
            <span className="current">
              ...
              {formatCurrency(walletData.savingsGoal)}
            </span>
          </div>
          <div className="progress-bar">
            <div
          ...
          <p className="remaining">
            Remaining:{" "}
            {formatCurrency(walletData.savingsGoal - walletData.currentBalance)}
          </p>
        </div>
        ...
        <p className="redirect-text">
          You will be redirected to KoraPay secure payment gateway
        </p>
      </form>
    </section>
  );
